                        ...
                        <Media>
                          <Media body>
                            <p className="text-muted font-weight-medium">
                              {totalPodcastChannels.title}
                            </p>
                            <h4 className="mb-0">
                              {totalPodcastChannels.description}
                            </h4>
                          </Media>
                          <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                            <span className="avatar-title">
                              <i
                                className={
                                  "bx " +
                                  totalPodcastChannels.iconClass +
                                  " font-size-24"
                                }
                              ></i>
                            </span>
                    ...
                    <Card className="mini-stats-wid">
                      <CardBody>
                        <Media>
                          <Media body>
                            <p className="text-muted font-weight-medium">
                              {totalPodcastFollows.title}
                            </p>
                            <h4 className="mb-0">
                              {totalPodcastFollows.description}
                            </h4>
                          </Media>
                          <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                            <span className="avatar-title">
                    ...
                    <Card className="mini-stats-wid">
                      <CardBody>
                        <Media>
                          <Media body>
                            <p className="text-muted font-weight-medium">
                              {totalRadioChannels.title}
                            </p>
                            <h4 className="mb-0">
                              {totalRadioChannels.description}
                            </h4>
                          </Media>
                          <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                            <span className="avatar-title">
                    ...
                    <Card className="mini-stats-wid">
                      <CardBody>
                        <Media>
                          <Media body>
                            <p className="text-muted font-weight-medium">
                              {totalAudioBooks.title}
                            </p>
                            <h4 className="mb-0">
                              {totalAudioBooks.description}
                            </h4>
                          </Media>
                          <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                            <span className="avatar-title">
                        ...
                        <Media>
                          ...
                          <div className="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                            <span className="avatar-title">
                              <i
                                className={
                                  "bx " + totalBooks.iconClass + " font-size-24"
                                }
                              ></i>
                            </span>
                          </div>
                  ...
                  <Col lg={6}>
                    <Card>
                      <CardBody>
                        ...
                        {data != null ? (
                          <Accessions userByAge={data.usersByAge} />
                        ) : null}
                      </CardBody>
                    </Card>
                  </Col>
                  ...
                  <Col lg={6}>
                    <Card>
                      <CardBody>
                        ...
                        {data != null ? (
                          <AccessByGender
                            acces_by_gender={data.usersByGender}
                          />
                        ) : null}
                      </CardBody>
                    </Card>
                    ...
                    {data != null ? (
                      <MostPopularPodcast
                        mostFollowedPodcastChannels={
                          data.mostFollowedPodcastChannels
                        }
                      />
                    ) : null}
                  </Col>
