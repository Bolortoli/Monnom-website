      ...
      >
        ...
        >
          <img
            ...
            src={`${process.env.REACT_APP_STRAPI_BASE_URL}${
              JSON.parse(localStorage.getItem("user_information")).user
                .profile_picture?.url
            }`}
            alt="Header Avatar"
          />
          <span className="d-none d-xl-inline-block ml-2 mr-1">
            {JSON.parse(localStorage.getItem("user_information")).user.username}
          </span>
